...
('monitors', 'Экран', 'Яркость', 'Частота обновления', 'Динамическая контрастность',' Интерфейс связи с ПК', null),
('phones', 'Экран', 'Процессор', 'Оперативная память(RAM)', 'Встроенная память (ROM)','Основная камера МПикс','Поддержка стандартов'),
('computers', '', '', '', '','',''),
('tvs', '', '', '', '','',''),
('watches', '', '', '', '','',''),
('tablets', '', '', '', '','',''),
...
(1, '27"/1920x1080 Пикс', '300 кд/кв.м', '75 Гц', '1 000 000:1', 'HDMI', null);

INSERT INTO phones (itemID, propdesc1, propdesc2, propdesc3, propdesc4, propdesc5, propdesc6) VALUES
(3, '6.6"/720x1612 Пикс', 'UNISOC Tiger T606 2 x 1.6ГГц + 6 x 1.4ГГц', '4 ГБ', '64 ГБ', '13/TOF/AF', '2G/3G/4G LTE');